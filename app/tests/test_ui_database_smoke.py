...
class UiDatabaseSmokeTest(unittest.TestCase):
    ...
    def test_cashier_products_and_reports_are_restricted(self):
        ...
        self.assertEqual(details.table.item(1, 8).text(), "↩️")
        self.assertEqual(details.table.item(1, 8).toolTip(), "Qisman qaytarilgan")
        self.assertEqual(details.table.item(1, 8).background().color().name(), "#fde68a")
